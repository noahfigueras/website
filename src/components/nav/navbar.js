	...
	render(){
	 ...
	 <div className="navContainer"> 	 
	   ...
	   <ul>
		 ...
		 <NavLink className="nav-btn link" to="/contact"><li>Contact</li></NavLink>
	   ...
	   <div className="footer">
		 ...
		 <a target="_blank" rel="noopener noreferrer" href="https://twitter.com/Noahfigueras17"><img className="icons" src={twitter}/></a>
